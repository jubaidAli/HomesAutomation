...
public class BasePageObject {
	...
	public void indexLinks(String actualLink) {
		/** Iterate through different links from browser */
		List<WebElement> pageLinks = driver.findElements(By.tagName("a"));
		System.out.println("All links found on web page are: " + pageLinks.size() + " links.");
	    
		for (WebElement link : pageLinks) {
			if(link.getAttribute("href") == actualLink) {
				openUrl(actualLink);
			}
		}
	}
